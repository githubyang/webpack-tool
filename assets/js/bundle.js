...
/******/ 	var hotCurrentHash = "bd869b4d81ffabe381fd"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement('div', { className: 'nav' }, _react2.default.createElement(_reactRouter.Link, { to: '/hello', className: 'hellolink' }, 'Say Hello'), _react2.default.createElement(_reactRouter.Link, { to: '/timer', className: 'timerlink' }, 'Timer'), this.props.children);
	  }
	});
	// import Forms from './form.js';

	(0, _reactDom.render)(_react2.default.createElement(_reactRouter.Router, { history: _reactRouter.browserHistory }, _react2.default.createElement(_reactRouter.Route, { path: '/', component: App }, _react2.default.createElement(_reactRouter.Route, { path: '/hello', component: _hello2.default }), _react2.default.createElement(_reactRouter.Route, { path: '/timer', component: _timer2.default }))), document.getElementById('content'));
